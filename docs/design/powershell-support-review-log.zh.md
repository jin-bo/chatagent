...
而 rev 19 是一遍编辑性整理、rev 32 与 rev 42 是结构修订、rev 45、rev 46、rev 50、rev 51 与 rev 52 是实施轮、rev 47 与 rev 49 是实测定案、rev 48 是一次定案轮，都不是一轮评审** —— 这就是「rev 2–53 那五十二行、合计三百五十三条」与「表头写
